...
type ServiceSplit struct {
	// An value between 0 and 100 reflecting what portion of traffic should be
...
func (e *ServiceResolverConfigEntry) Validate() error {
	...
	if e.Redirect != nil {
		...
		if r.Service == "" {
			...
			// TODO: handle validating subsets for other services
		}
	}
	...
	if len(e.Failover) > 0 {
		for subset, f := range e.Failover {
			...
			// TODO: more extensive validation will require graph traversal
